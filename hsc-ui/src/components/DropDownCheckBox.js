...
const DropdownCheckbox = () => {
  ...
  <div className="relative inline-block text-left" ref={dropdownRef}>
    ...
    {isOpen && (
      <div className="absolute z-10 mt-2 w-96 max-h-80 overflow-y-auto bg-white divide-y divide-gray-100 rounded-lg shadow-sm dark:bg-gray-700 dark:divide-gray-600">
